...
transformed data {
  ...
  matrix[Ntrial, Nsubject] condition;  // Convert incentive to 0/1 (0=low, 1=high)
  ...
  for (s in 1:Nsubject) {
    for (t in 1:Ntrial) {
      ...
      // Convert incentive to condition 
...
generated quantities {
  // Calculate effects
  real bdi_effect = mu_beta1;           // Main BDI effect
